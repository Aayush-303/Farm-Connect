...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=976c105fb20d4cb3b0bc1569f0f1b383";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
        ...
        $url="https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=976c105fb20d4cb3b0bc1569f0f1b383";   //Your API KEY
