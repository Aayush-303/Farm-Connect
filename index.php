...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/logo.png" />
    <title>Farmer Connect Portal</title>
        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Farmer Connect Portal</h1>
              <p class="text-white">
...
const apiKey = "sk-proj-F1mRwMn07tX70STgvW8ET3BlbkFJpiMzsPAr6acsOx0SRGWM";   // Enter your apikey here
